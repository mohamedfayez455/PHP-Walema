...
<div class="row">
  <div class="col-sm-4 col-xs-12">
    <div class="panel panel-default panel-card">
      <div class="panel-heading">
        Listings <span class="label label-primary">Today</span>
      </div>
      <div class="panel-body">
        <h2> {{ count( supplier()->listings ) }} </h2>
      </div>
    </div>
  </div>
  <div class="col-sm-4 col-xs-12">
  ...
  <div class="col-sm-4 col-xs-12">
    <div class="panel panel-default panel-card">
      ...
      <div class="panel-body">
        <h2>{{ count( supplier()->customerSearchSupplier ) }}</h2>
      </div>
    </div>
  </div>
</div>
        ...
        <ul class="list-unstyled panel-list">
          ...
          <li>
            <div class="listWrapper">
              <div class="listName">
                <h3>{{ $listing->name }}<small>{{ $listing->city }}</small></h3>
              </div>
        ...
        <ul class="list-styled panel-list list-padding-sm">
          ...
          <li  class="listWrapper">
            <span class="recentUserInfo">
              ...
              @endif
              <a href="{{ route('customer.profile' , $user->customer->id) }}" href="" style="font-size:11px;font-weight: bold;"> {{ $user->firstname . ' ' . $user->lastname }} </a>
    ...
    <div class="panel panel-default panel-card">
      ...
      <div class="panel-body panel-message">
        <ul class="list-unstyled panel-list">
          ...
          @forelse( supplier()->friends_collection() as $user )
            ...
            @endif
          @empty
          <li>You Never Connect With Any Customer </li>
    ...
    <div class="panel panel-default panel-card">
      ...
      <div class="panel-body panel-message">
        <ul class="list-unstyled panel-list">
          ...
          @forelse( supplier()->complaints() as $complaint )

          <li>
            <span class="messageInfo">
              <h5 class="name">
                <a href="{{ route('customer.profile' , $complaint->sender->customer->id) }}">
                  {{ $complaint->sender->firstname . ' ' . $complaint->sender->lastname }}
                </a>
              </h5>
    ...
    <div class="panel panel-default panel-card">
      ...
      <div class="panel-body panel-message">
        <ul class="list-unstyled panel-list">
          ...
          @forelse( supplier()->enquries() as $enqury)

          <li>
            <span class="messageInfo">
              <h5 class="name">
                <a href="{{ route('customer.profile' , $enqury->sender->customer->id) }}">
                  {{ $enqury->sender->firstname . ' ' . $enqury->sender->lastname }}
                </a>
              </h5>
